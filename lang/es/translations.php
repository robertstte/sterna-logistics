...
return [
        ...
        "table" => [
            "orders" => [
                ...
                "details" => [
                    ...
                    "select_transport" => "Seleccionar transporte",
                ...
                "request_new" => "Solicitar Nuevo Pedido",
                "request" => "Solicitar",
                "request_success" => "Solicitud enviada correctamente",
                "request_approved" => "Solicitud aprobada correctamente",
                "request_rejected" => "Solicitud rechazada",
                "requests" => "Solicitudes de Pedidos",
    ...
    "myAccount" => [
        ...
        "order_updates" => "Recibir actualizaciones de pedidos",
        "language" => "Idioma",
        "spanish" => "Español",
        "english" => "English",
